...
export default function QueryForm3({ title }: { title: string }) {
    ...
    <main className="min-h-screen bg-white px-4 py-16 w-full max-w-[1371px] mx-auto  overflow-hidden max-sm:px-0">
      <div className="max-w-[1371px]  w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div className="text-md bg-[#222] mr-auto mt-[-24px] w-[121px] cursor-pointer text-white font-outfit rounded-sm px-5 py-2 flex justify-center items-center "
