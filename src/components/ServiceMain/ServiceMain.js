      ...
      <div className="max-w-7xl mx-auto mb-16">
        <div className="relative">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-14 z-10 w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white hover:bg-green-600 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
          >
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-14 z-10 w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white hover:bg-green-600 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
          >
              ...
              {servicesData.services.map((service) => {
                ...
                return (
                  <div
                    ...
                    className={`flex-shrink-0 w-[calc(33.333%-16px)] cursor-pointer transition-all duration-300 ${
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Title */}
                      <h3 className="text-center text-xs font-bold text-gray-800 mb-3 min-h-[32px] tracking-wide">
                        {service.title}
                      </h3>

                      {/* Description */}
                      <p className="text-center text-[10px] text-gray-600 mb-5 leading-relaxed min-h-[48px]">
                        {service.description}
                      </p>
