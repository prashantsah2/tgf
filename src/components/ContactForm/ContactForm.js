      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-stone-200/60 rounded-3xl p-6 md:p-12 grid lg:grid-cols-2 gap-8 md:gap-12 bg-[#fff]">
          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-3xl md:text-3xl font-bold text-gray-900 mb-3 flex"><p className="text-teal-500" >CONTACT </p><p className='text-blue-500'>US</p></h1>
            ...
            <div className="space-y-6 md:space-y-8">
              {/* Email Section */}
              <div className="bg-white/30 p-4 pl-0 rounded-xl backdrop-blur-sm">
