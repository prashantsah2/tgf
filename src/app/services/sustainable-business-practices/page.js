...
export default function PageMain({
  ...
  subtitle = `Our solutions accelerate the transition to a low-carbon future, reducing emissions across the
value chain while unlocking opportunities for climate resilience and sustainable growth.`,
  featuredTitle = "FEATURED SERVICES",
  featuredServices = [
    { icon: "ClipboardList", title: "FEASIBILITY STUDY" },
    { icon: "Leaf", title: "CARBON PROJECT CONSULTING ADVISORY" },
    { icon: "CheckCircle", title: "CARBON NEUTRALITY" },
    { icon: "Users", title: "CARBON FINANCING" },
    { icon: "Users", title: "TRADING OF CREDITS" }
  ],
